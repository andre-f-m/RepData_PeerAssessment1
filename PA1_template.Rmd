...
The median value shows a little difference (old: `r format(round(median(dfStepsPerDay$steps),2), nsmall=2)`, new: `r format(round(median(dfStepsPerDayUpdated$steps), 2), nsmall=2)`) and is now the same as mean.
